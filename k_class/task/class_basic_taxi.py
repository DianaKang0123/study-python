...
# 1. 택시 객체 생성시 승객별로 돈과, 거리를 받아서 생성
# 2. 택시 객체 생성시 택시 수익을 초기화한다.
...
#     basic_amount = 1000
#
#     def __init__(self, fee, mile,price=0):
#         self.fee = fee
#         self.mile = mile
#         self.price=price
#
#     def charge(self):
#         cost = Texi.basic_fee
#         if self.mile > Texi.basic_mile:
#             cost += (self.mile - Texi.basic_mile) * Texi.basic_amount
#             return cost
#
#
#     def change(self):
#         return self.fee - self.charge()
#
# -------------------------------
# 1.
class Taxi:
